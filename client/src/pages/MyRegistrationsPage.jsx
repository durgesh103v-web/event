...
const s = {
  ...
  title: { color: '#f8fafc', fontSize: 'clamp(1.6rem,3vw,2.4rem)', fontWeight: 900, letterSpacing: '-0.03em', margin: 0 },
  ...
  skeleton: {
    ...
    background: 'linear-gradient(90deg,#111827 25%,#273449 50%,#111827 75%)',
  ...
  emptyTitle: { color: '#f8fafc', fontSize: '1.2rem', fontWeight: 800, margin: 0 },
  emptySub: { color: '#94a3b8', fontSize: '0.9rem', margin: 0, maxWidth: 320 },
  browseBtn: {
    alignItems: 'center',
